...
public class BookActivity extends AppCompatActivity {
    ...
    private TextView textBookName, txtAuthor, txtPages, txtDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   Book book = new Book(1, " In Search of Lost Time", "Marcel Proust", 200, "https://thegreatestbooks.org/rails/active_storage/blobs/redirect/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBbkFDIiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--012c8f7614cfb601fe7c68fb3b056a63cdcf0d06/51Wrlbko5QL.jpg",
    ...
    private void handleAlreadyRead(Book book) {
        ...
        if (existInAlreadyReadBooks) {
            ...
            btnAddToAlreadyRead.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (Utils.getInstance(BookActivity.this).addToAlreadyBooks(book)) {
                        Toast.makeText(BookActivity.this, "Book added", Toast.LENGTH_SHORT).show();
